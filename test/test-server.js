...
describe('BlogPosts', function() {
  ...
  it('should update items on PUT', function() {
    ...
    const updateData = {
      title: 'Updated Title this one is really good',
      content: 'Ignore that previous article this one is the right one!',
      author: 'Dude Authority',
      publishDate: Date.now()
    };
  ...
  it('should delete items on DELETE', function() {
    return chai.request(app)
      ...
      .get(appUrl)
      .then(function(res) {
        // console.log('DELETE post: ', res.body[0]);
        return chai.request(app)
          .delete(`${appUrl}/${res.body[0].id}`);
      })
      .then(function(res) {
